    ...
    module.exports = function(max) {
      ...
      return {
        ...
        set: function(key, value) {
          if (cache[key] !== void 0) cache[key] = value;
...
function getLruCache(cacheSize) {
  if (cacheSize >= 1) {
    return (0, import_hashlru.default)(cacheSize);
  }
  return {
    get: () => void 0,
    set: () => {
...
function createPrefixUtils(config) {
  ...
  function isPrefixValid(maybePrefix) {
    return prefixToIndexMap[maybePrefix] !== void 0;
  }
...
var ROUNDED = ["none", "", ...SIZES_SIMPLE, "3xl", "full", isCustomLength];
...
function mergeClassList(classList, configUtils) {
  ...
  return classList.trim().split(SPLIT_CLASSES_REGEX).map((originalClassName) => {
    ...
    const classGroupId = arePrefixesValid ? getClassGroupId(className) : void 0;
    if (!classGroupId) {
      return {
...
var twMerge = createTailwindMerge((defaultConfig) => defaultConfig());
export {
  createTailwindMerge,
  twMerge
};
